...
function MainCard({ mini, URL, score, title, id }) {
  const navigate = useNavigate();

  return (
    <div
      onClick={() => navigate(`/details/${id}`)}
      className={`flex flex-col justify-start cursor-pointer items-start bg-black ${mini ? "w-[250px]  h-[150px]" : "min-w-[360px]  h-[320px]"}  border border-[#50C878] rounded-3xl`}
    >
      <div
